...
#define NEGATIVE '-'
#ifdef _64_BIT
#define BASE 18446744073709551616   /* 2^64 */
#define BASE_CARRY 10000000000000000000
#else
#define BASE 4294967296 /* 2^32 */
#define BASE_CARRY 1000000000
#endif
...
#ifndef _64_BIT
typedef _ulong unsigned int
typedef _long  int
#else
typedef _ulong unsigned long long
typedef _long long long
#endif
